            ...
            <div>
              <dl className=" space-y-1 px-2 py-4">
                <div className="flex items-center justify-between">
                  <dt className="text-sm text-gray-800">Price ({props.cart.length} item)</dt>
                  <dd className="text-sm font-medium text-gray-900">₹ {totalItem}</dd>
                </div>
                ...
                <div className="flex items-center justify-between border-y border-dashed py-4 ">
                  ...
                  <dd className="text-base font-medium text-gray-900">₹ {totalItem}</dd>
                </div>
              </dl>
            </div>
          </section>
